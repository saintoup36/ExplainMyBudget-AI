...
# Expanded French UI coverage for buttons, dashboard text, alerts, reports, and premium screens.
TRANSLATIONS.setdefault("French", {}).update(
{'AI Budget Generator': 'Générateur de budget IA', 'AI Command Center': 'Centre de commande IA', 'AI Insights & Smart Analysis': 'Analyses IA et analyse intelligente', 'AI not connected': 'IA non connectée', 'Add budget categories first.': "Ajoutez d'abord des catégories de budget.", 'Add categories like housing, food, transport, bills, savings, and debt.': 'Ajoutez des catégories comme logement, alimentation, transport, factures, épargne et dettes.', 'Add expenses first so the app can create a challenge.': "Ajoutez d'abord des dépenses afin que l'application puisse créer un défi.", 'Add expenses first so the app can detect changes.': "Ajoutez d'abord des dépenses afin que l'application puisse détecter les changements.", 'Add expenses first to detect patterns.': "Ajoutez d'abord des dépenses pour détecter les habitudes.", 'Add expenses first to see trends.': "Ajoutez d'abord des dépenses pour voir les tendances.", 'Add income and expenses to discover your money personality.': 'Ajoutez vos revenus et dépenses pour découvrir votre profil financier.', 'Add more expense dates to detect a trend.': 'Ajoutez davantage de dates de dépenses pour détecter une tendance.', 'Add your budget first.': "Ajoutez d'abord votre budget.", 'Add your income first': "Ajoutez d'abord votre revenu", 'Add your income first to create a complete snapshot.': "Ajoutez d'abord votre revenu pour créer un aperçu complet.", 'Add your monthly income first so I can answer accurately.': "Ajoutez d'abord votre revenu mensuel pour que je puisse répondre avec précision.", 'Add your monthly income first.': "Ajoutez d'abord votre revenu mensuel.", 'Add your monthly income to earn your first badge.': 'Ajoutez votre revenu mensuel pour gagner votre premier badge.', 'Add your monthly income to generate a full report.': 'Ajoutez votre revenu mensuel pour générer un rapport complet.', 'Adjust your planned budget or cut spending in key categories.': 'Ajustez votre budget prévu ou réduisez les dépenses dans les catégories clés.', 'Advanced Reports': 'Rapports avancés', 'Badges Earned': 'Badges gagnés', 'Budget Burn': 'Consommation du budget', 'Budget data restored.': 'Données du budget restaurées.', 'Challenge: No non-essential spending for the next 3 days.': 'Défi : aucune dépense non essentielle pendant les 3 prochains jours.', 'Challenge: Reduce flexible spending by 15% this week.': 'Défi : réduisez les dépenses flexibles de 15 % cette semaine.', 'Challenge: Save an extra': 'Défi : économisez davantage', 'Challenge: Track every expense for the next 7 days.': 'Défi : suivez chaque dépense pendant les 7 prochains jours.', 'Consider building an emergency fund and improving savings discipline.': "Envisagez de constituer un fonds d'urgence et d'améliorer votre discipline d'épargne.", 'Consider growing assets through savings or investments.': "Envisagez d'augmenter vos actifs grâce à l'épargne ou aux investissements.", 'Continue tracking your expenses and consider increasing your savings goal.': "Continuez à suivre vos dépenses et envisagez d'augmenter votre objectif d'épargne.", 'Copy Your Snapshot': 'Copier votre aperçu', 'Create your first budget categories to unlock the dashboard.': 'Créez vos premières catégories de budget pour débloquer le tableau de bord.', 'Create your first budget category.': 'Créez votre première catégorie de budget.', 'Current Settings': 'Paramètres actuels', 'Cut flexible categories like shopping, entertainment, or dining out.': 'Réduisez les catégories flexibles comme les achats, les loisirs ou les repas au restaurant.', 'Debt Payoff Planner': 'Planificateur de remboursement des dettes', 'Download AI Insights Report': "Télécharger le rapport d'analyses IA", 'Download Budget CSV': 'Télécharger le CSV du budget', 'Download Expenses CSV': 'Télécharger le CSV des dépenses', 'Download Snapshot': "Télécharger l'aperçu", 'Download Your Data': 'Télécharger vos données', 'Emergency Fund': "Fonds d'urgence", 'Example: Can I save 500 this month?': 'Exemple : puis-je économiser 500 ce mois-ci ?', 'Expense data restored.': 'Données des dépenses restaurées.', 'Export cleaner reports for review and planning.': "Exportez des rapports plus clairs pour l'examen et la planification.", 'Focus on reducing flexible expenses like shopping or entertainment.': 'Concentrez-vous sur la réduction des dépenses flexibles comme les achats ou les loisirs.', 'Forecasting & Scenario Planning': 'Prévisions et planification de scénarios', 'Full access': 'Accès complet', 'Generate Budget Plan': 'Générer un plan de budget', 'Generate smarter money explanations and next steps.': 'Générez des explications financières plus intelligentes et les prochaines étapes.', 'Go to income': 'Aller au revenu', 'Go to 💎 Upgrade to unlock this feature.': 'Allez à 💎 Mise à niveau pour débloquer cette fonctionnalité.', 'Goals Dashboard': 'Tableau de bord des objectifs', 'Healthy': 'Sain', 'Immediate budget adjustment is critical. Focus on essentials.': "Un ajustement immédiat du budget est essentiel. Concentrez-vous sur l'essentiel.", 'Import Transactions': 'Importer des transactions', 'Imported successfully': 'Importation réussie', 'Income': 'Revenu', 'Income is missing. Add your monthly income so the app can judge your budget accurately.': "Le revenu est manquant. Ajoutez votre revenu mensuel afin que l'application puisse évaluer votre budget correctement.", 'Invalid budget file. It must include Category and Planned columns.': 'Fichier de budget invalide. Il doit inclure les colonnes Category et Planned.', 'Invalid expenses file. It must include Date, Category, Description, and Amount columns.': 'Fichier de dépenses invalide. Il doit inclure les colonnes Date, Category, Description et Amount.', 'Invalid format': 'Format invalide', 'Jump straight into the tools people use most.': 'Accédez directement aux outils les plus utilisés.', 'Keep tracking consistently to protect your budget streak.': 'Continuez à suivre régulièrement pour protéger votre série budgétaire.', 'Keep tracking consistently. Your spending pattern looks balanced.': 'Continuez à suivre régulièrement. Votre profil de dépenses semble équilibré.', 'Keep tracking. Your plan has breathing room right now.': 'Continuez à suivre. Votre plan a encore une marge de manœuvre.', 'Key Insight': 'Observation clé', 'Load starter categories': 'Charger les catégories de départ', 'Log spending so the dashboard can show alerts, trends, and remaining money.': 'Enregistrez vos dépenses pour que le tableau de bord affiche les alertes, tendances et montants restants.', 'Maintain consistency and monitor trends over time.': 'Restez constant et surveillez les tendances au fil du temps.', 'Money Coach': 'Coach financier', 'Monthly Stripe price ID not connected yet.': "L'identifiant du prix mensuel Stripe n'est pas encore connecté.", 'Monthly Subscriptions': 'Abonnements mensuels', 'Months of coverage': 'Mois de couverture', 'Most of your money is going toward': 'La plus grande partie de votre argent va vers', 'Most of your money went to': 'La plus grande partie de votre argent est allée à', 'Net Worth': 'Valeur nette', 'Next Best Action': 'Meilleure prochaine action', 'Next best move': 'Meilleure prochaine action', 'No budget yet. Use the quick actions below to build your first monthly plan.': 'Aucun budget pour le moment. Utilisez les actions rapides ci-dessous pour créer votre premier plan mensuel.', 'No subscription': 'Aucun abonnement', 'None yet': 'Aucun pour le moment', 'Not enough data yet': 'Pas encore assez de données', 'One-time Stripe price ID not connected yet.': "L'identifiant du prix Stripe en paiement unique n'est pas encore connecté.", 'Open upgrade': 'Ouvrir la mise à niveau', 'Optimizing': 'Optimisation', 'Over budget': 'Budget dépassé', 'Pause flexible spending and fix the category that crossed its limit first.': "Mettez les dépenses flexibles en pause et corrigez d'abord la catégorie qui a dépassé sa limite.", 'Pause non-essential spending and review the categories where you went over budget.': 'Mettez les dépenses non essentielles en pause et examinez les catégories qui ont dépassé le budget.', 'Plan across currencies with clearer context.': 'Planifiez entre plusieurs devises avec un contexte plus clair.', 'Points': 'Points', 'Premium reports': 'Rapports Premium', 'Prioritize paying down high-interest debt first.': "Priorisez d'abord le remboursement des dettes à taux d'intérêt élevé.", 'Protect the remaining budget by slowing down non-essential spending.': 'Protégez le budget restant en ralentissant les dépenses non essentielles.', 'Quick Actions': 'Actions rapides', 'Real AI is not connected yet. Add OPENAI_API_KEY to your environment to activate it.': "L'IA réelle n'est pas encore connectée. Ajoutez OPENAI_API_KEY à votre environnement pour l'activer.", 'Recommended Action': 'Action recommandée', 'Reduce flexible spending and build a safety buffer.': 'Réduisez les dépenses flexibles et créez une marge de sécurité.', 'Reduce non-essential spending immediately and rebalance your budget.': 'Réduisez immédiatement les dépenses non essentielles et rééquilibrez votre budget.', 'Reduce planned spending categories until your total budget is below your income.': "Réduisez les catégories de dépenses prévues jusqu'à ce que votre budget total soit inférieur à votre revenu.", 'Remaining income': 'Revenu restant', 'Restore Budget Data': 'Restaurer les données du budget', 'Restore Expenses Data': 'Restaurer les données des dépenses', 'Review': 'Révision', 'Review high-spending categories and reduce non-essential expenses.': 'Examinez les catégories à fortes dépenses et réduisez les dépenses non essentielles.', 'Right now, you have about': 'En ce moment, vous avez environ', 'Runway': 'Marge disponible', 'Savings risk': "Risque pour l'épargne", 'See possible overspending before it happens.': "Voyez les risques de dépassement avant qu'ils ne se produisent.", 'Set a savings goal first. Right now I can only estimate your remaining income.': "Définissez d'abord un objectif d'épargne. Pour l'instant, je peux seulement estimer votre revenu restant.", 'Set a savings goal to unlock another badge.': "Définissez un objectif d'épargne pour débloquer un autre badge.", 'Set your Stripe Checkout success URL to include the checkout session id.': "Définissez l'URL de succès Stripe Checkout pour inclure l'identifiant de session checkout.", 'Small weekly challenges make budgeting easier because they turn money management into simple actions.': "De petits défis hebdomadaires rendent le budget plus facile en transformant la gestion de l'argent en actions simples.", 'Smart savings guidance': "Conseils d'épargne intelligents", 'Spending Ratio': 'Ratio de dépenses', 'Spent so far': "Dépensé jusqu'ici", 'Start by adding income, budget categories, or expenses to earn badges.': 'Commencez par ajouter un revenu, des catégories de budget ou des dépenses pour gagner des badges.', 'Start by entering your monthly income.': 'Commencez par saisir votre revenu mensuel.', 'Start your money command center': 'Démarrez votre centre de commande financier', 'Step 1: Build your budget': 'Étape 1 : créez votre budget', 'Step 2: Track expenses': 'Étape 2 : suivez vos dépenses', 'Step 3: Get guidance': 'Étape 3 : obtenez des conseils', 'Stripe price ID not connected yet. Check STRIPE_PRICE_MONTHLY or STRIPE_PRICE_ONE_TIME in .env / Streamlit Secrets.': "L'identifiant de prix Stripe n'est pas encore connecté. Vérifiez STRIPE_PRICE_MONTHLY ou STRIPE_PRICE_ONE_TIME dans .env / Streamlit Secrets.", 'Subscription Tracker': 'Suivi des abonnements', 'Target Fund': 'Fonds cible', 'This is the currency you use when typing income, budgets, expenses, bills, assets, and debts.': "C'est la devise utilisée lorsque vous saisissez revenus, budgets, dépenses, factures, actifs et dettes.", 'This purchase may affect your savings goal.': "Cet achat peut affecter votre objectif d'épargne.", 'Tight': 'Serré', 'Top Category': 'Catégorie principale', 'Top Spend': 'Plus grosse dépense', 'Total Assets': 'Total des actifs', 'Total Debt': 'Dette totale', 'Total Liabilities': 'Total des passifs', 'Track your first expense.': 'Suivez votre première dépense.', 'Upload Budget CSV': 'Téléverser le CSV du budget', 'Upload CSV': 'Téléverser un CSV', 'Upload Expenses CSV': 'Téléverser le CSV des dépenses', 'Use AI-style recommendations to understand what changed and what to do next.': 'Utilisez des recommandations de style IA pour comprendre ce qui a changé et quoi faire ensuite.', 'Use the sidebar to change language, currency, section, and plan.': 'Utilisez la barre latérale pour changer la langue, la devise, la section et le plan.', 'Use these Streamlit Secrets or .env values:': 'Utilisez ces valeurs Streamlit Secrets ou .env :', 'Watch': 'Surveiller', 'Yes. Based on your current spending, you have': "Oui. D'après vos dépenses actuelles, il vous reste", 'You are close to using your full budget.': "Vous êtes proche d'utiliser tout votre budget.", 'You are close to your monthly budget limit.': 'Vous êtes proche de votre limite budgétaire mensuelle.', 'You are currently spending more than your planned budget.': 'Vous dépensez actuellement plus que votre budget prévu.', 'You are over your planned budget. Review high-spending categories.': 'Vous dépassez votre budget prévu. Examinez les catégories à fortes dépenses.', 'You are spending more than your income. Immediate action is needed.': 'Vous dépensez plus que votre revenu. Une action immédiate est nécessaire.', 'You can afford this.': 'Vous pouvez vous le permettre.', 'You concentrate spending heavily on': 'Vous concentrez fortement vos dépenses sur', 'You have already used more than 75% of your income.': 'Vous avez déjà utilisé plus de 75 % de votre revenu.', 'You have exceeded your monthly budget.': 'Vous avez dépassé votre budget mensuel.', 'You have spent': 'Vous avez dépensé', 'You spend conservatively and retain a strong portion of your income.': 'Vous dépensez prudemment et conservez une bonne partie de votre revenu.', 'You spend most of your income. Little margin for savings.': "Vous dépensez la majeure partie de votre revenu. Il reste peu de marge pour l'épargne.", 'You tend to spend more than you earn. High financial risk.': 'Vous avez tendance à dépenser plus que vous ne gagnez. Risque financier élevé.', 'You will have': 'Vous aurez', 'You will still have': 'Il vous restera encore', 'Your Level': 'Votre niveau', 'Your budget looks healthy. Keep tracking expenses consistently.': 'Votre budget semble sain. Continuez à suivre vos dépenses régulièrement.', 'Your budget looks stable right now.': 'Votre budget semble stable pour le moment.', 'Your current spending may prevent you from reaching your savings goal.': "Vos dépenses actuelles peuvent vous empêcher d'atteindre votre objectif d'épargne.", 'Your largest category is': 'Votre plus grande catégorie est', 'Your liabilities exceed your assets. Focus on reducing debt.': 'Vos passifs dépassent vos actifs. Concentrez-vous sur la réduction des dettes.', 'Your net worth is in a healthy range.': 'Votre valeur nette se situe dans une zone saine.', 'Your net worth is positive but relatively low compared to your assets.': 'Votre valeur nette est positive mais relativement faible par rapport à vos actifs.', 'Your planned budget fits within your income.': 'Votre budget prévu respecte votre revenu.', 'Your planned budget is': 'Votre budget prévu est', 'Your planned budget is higher than your income. This budget may not be realistic.': "Votre budget prévu est supérieur à votre revenu. Ce budget n'est peut-être pas réaliste.", 'Your savings goal is at risk.': "Votre objectif d'épargne est à risque.", 'Your savings goal may be at risk. Reduce flexible spending.': "Votre objectif d'épargne peut être à risque. Réduisez les dépenses flexibles.", 'Your savings goal may be at risk. You have': "Votre objectif d'épargne peut être à risque. Il vous reste", 'Your savings goal needs protection. Cut one flexible category this week.': "Votre objectif d'épargne doit être protégé. Réduisez une catégorie flexible cette semaine.", 'Your savings goal still looks reachable.': "Votre objectif d'épargne semble encore atteignable.", 'Your spending appears fairly balanced across categories.': 'Vos dépenses semblent assez équilibrées entre les catégories.', 'Your spending is controlled and well distributed.': 'Vos dépenses sont contrôlées et bien réparties.', 'Your spending is currently on track.': 'Vos dépenses sont actuellement sur la bonne voie.', 'Your spending is currently under control.': 'Vos dépenses sont actuellement sous contrôle.', 'Your spending is spread across categories. No single category dominates your budget.': 'Vos dépenses sont réparties entre les catégories. Aucune catégorie ne domine votre budget.', 'Your spending looks controlled.': 'Vos dépenses semblent contrôlées.', 'Your spending trend is decreasing. Good control.': 'Votre tendance de dépenses diminue. Bon contrôle.', 'Your spending trend is increasing. Watch your pace.': 'Votre tendance de dépenses augmente. Surveillez votre rythme.', 'Your spending trend is stable.': 'Votre tendance de dépenses est stable.', 'alone could significantly improve your finances': 'à lui seul pourrait améliorer considérablement vos finances', 'and you have spent': 'et vous avez dépensé', 'available after spending': 'disponible après dépense', 'closely this month.': 'de près ce mois-ci.', 'first. Even a small cut there could make a big difference.': 'en premier. Même une petite réduction à cet endroit peut faire une grande différence.', 'is your largest spending category at': 'est votre plus grande catégorie de dépenses avec', 'left': 'restants', 'remaining': 'restant', 'left, but your goal is': 'restants, mais votre objectif est', 'left, so your savings goal still looks reachable.': "restants, donc votre objectif d'épargne semble encore atteignable.", 'making up': 'représentant', 'of all spending.': 'de toutes les dépenses.', 'of spending': 'des dépenses', 'of your total spending. This category may be controlling your budget.': 'de vos dépenses totales. Cette catégorie peut contrôler votre budget.', 'represents': 'représente', 'so far this month': "jusqu'ici ce mois-ci", 'this week': 'cette semaine', 'which is influencing your overall financial behavior.': 'ce qui influence votre comportement financier global.', 'which makes up': 'ce qui représente', '⚙️ Settings': '⚙️ Paramètres', '⚠️ You are currently spending more than your income.': '⚠️ Vous dépensez actuellement plus que votre revenu.', '⚠️ You have exceeded your planned budget.': '⚠️ Vous avez dépassé votre budget prévu.', '⚠️ Your savings goal is at risk.': "⚠️ Votre objectif d'épargne est à risque.", '✅ No major budget risks detected. Your spending looks controlled.': '✅ Aucun risque budgétaire majeur détecté. Vos dépenses semblent contrôlées.', '✅ Suggested Next Move': '✅ Prochaine action suggérée', '✅ Why This Helps': '✅ Pourquoi cela aide', '✅ Your financial situation looks stable.': '✅ Votre situation financière semble stable.', '✏️ Edit Budget Categories': '✏️ Modifier les catégories de budget', '➕ Add Bill': '➕ Ajouter une facture', '➕ Add One Budget Category': '➕ Ajouter une catégorie de budget', '🌍 Context': '🌍 Contexte', '🌍 Display Currency': "🌍 Devise d'affichage", '🌍 Global Context': '🌍 Contexte global', '🌍 Global Control': '🌍 Contrôle global', '🌍 Global currency': '🌍 Devise mondiale', '🌐 Language': '🌐 Langue', '🎉 Payment successful! Please sign in to refresh Premium access.': "🎉 Paiement réussi ! Connectez-vous pour actualiser l'accès Premium.", '🎉 Payment successful! Premium unlocked for this signed-in account.': '🎉 Paiement réussi ! Premium débloqué pour ce compte connecté.', '🎯 Spending Challenge Mode': '🎯 Mode défi de dépenses', '🏆 Money Rewards': '🏆 Récompenses financières', '🏆 Rewards': '🏆 Récompenses', '🏦 Base Currency': '🏦 Devise de base', '💎 Upgrade to Premium': '💎 Passer à Premium', '💡 Decision': '💡 Décision', '💡 Recommendation': '💡 Recommandation', '💰 Assets': '💰 Actifs', '💰 Total Budget': '💰 Budget total', '💳 Liabilities': '💳 Passifs', '💵 Income Left': '💵 Revenu restant', '💸 Total Spent': '💸 Total dépensé', '💾 Backup & Restore': '💾 Sauvegarde et restauration', '📅 AI Insights Report': "📅 Rapport d'analyses IA", '📈 Growth Tip': '📈 Conseil de progression', '📈 Income Snapshot': '📈 Aperçu du revenu', '📈 Spending Pattern Detection': '📈 Détection des habitudes de dépenses', '📉 Spending Trends Over Time': '📉 Tendances des dépenses dans le temps', '📊 Category Summary': '📊 Résumé par catégorie', '📊 Financial Overview': "📊 Vue d'ensemble financière", '📊 Net Worth Tracker': '📊 Suivi de la valeur nette', '📊 Reports': '📊 Rapports', '📊 Savings Rate': "📊 Taux d'épargne", '📊 Summary': '📊 Résumé', '📋 Bills': '📋 Factures', '📝 Set Monthly Budget': '📝 Définir le budget mensuel', '📤 Shareable Money Snapshot': '📤 Aperçu financier partageable', '📱 Mobile-ready': '📱 Prêt pour mobile', '🔍 Analysis': '🔍 Analyse', '🔍 Diagnosis': '🔍 Diagnostic', '🔍 Spending Breakdown': '🔍 Répartition des dépenses', '🔥 Ask Your Money AI': '🔥 Demandez à votre IA financière', '🚦 Bill Status': '🚦 État des factures', '🚨 Bill Reminder Center': '🚨 Centre de rappels de factures', '🚨 Smart Alerts Center': "🚨 Centre d'alertes intelligentes", '🚫 You cannot afford this. It exceeds your available income.': '🚫 Vous ne pouvez pas vous le permettre. Cela dépasse votre revenu disponible.', '🟢 Remaining': '🟢 Restant', '🤖 AI-style insights': '🤖 Analyses de style IA', '🤖 Real AI Response': '🤖 Réponse IA réelle', '🧠 AI Answer': '🧠 Réponse IA', '🧠 AI Money Coach': '🧠 Coach financier IA', '🧠 Insight': '🧠 Aperçu', '🧠 Smart Explanation': '🧠 Explication intelligente', '🧠 Smart Recommendation': '🧠 Recommandation intelligente', '🧠 What Changed This Month?': "🧠 Qu'est-ce qui a changé ce mois-ci ?", '🧠 Your Challenge': '🧠 Votre défi', '🧠 Your Type': '🧠 Votre profil', '🧬 Your Money Personality': '🧬 Votre personnalité financière', '🧭 Financial Health Score': '🧭 Score de santé financière', '🧮 Can I Afford This?': '🧮 Puis-je me le permettre ?', '🧹 Reset & Cleanup': '🧹 Réinitialisation et nettoyage', '🩺 Budget Doctor': '🩺 Docteur du budget'}
)
...
def require_premium(feature_name="this feature"):
    if not is_premium_user():
        ...
        # Upgrade button
        if st.button(t("💎 Upgrade to Premium"), key=f"upgrade_{feature_name}"):
...
"""
    ...
    file = st.file_uploader(t("Upload CSV"))
